...
!!! note "GitHub Pages Settings"
    If your pages url is not loading, make sure you set the **Source** in your [pages settings](https://github.com/{{cookiecutter.github_user}}/{{cookiecutter.github_repo}}/settings/pages) to `gh-pages` and use the _root_ directory. Pages will then be built and deployed with the pages url as the default.
