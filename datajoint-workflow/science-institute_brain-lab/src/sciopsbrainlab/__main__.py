...
Example:
    Usage as a console entrypoint:
        ...
        sciopsbrainlab --help
        sciopsbrainlab --version

    Usage as a script:

        python -m sciopsbrainlab

    Usage from python:

        from sciopsbrainlab import main; main(...)
"""
...
from sciopsbrainlab import version
...
def cli() -> None:
    """_Calls [`__main__.main`][sciopsbrainlab.__main__.main], passing the cli
